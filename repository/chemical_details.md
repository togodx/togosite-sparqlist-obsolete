# pubchem, chemblのIDを入力して化合物の詳細情報を出す（信定・山本）
...
prefix skos: <http://www.w3.org/2004/02/skos/core#>
 ...
 SELECT ?pubchem_id  ?chembl_id ?pubchem_label  ?chembl_label ?molecular_formula ?molecular_weight ?smiles ?inchi  ?formula_figure
 {SELECT ?pubchem_id  ?chembl_id ?pubchem_label ?molecular_formula ?molecular_weight ?smiles ?inchi  ?formula_figure
(GROUP_concat(?label_temp; separator = ", ") as ?chembl_label)
