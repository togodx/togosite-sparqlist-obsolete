...
* `id`
  * default:　517068
  * example: 517068, 15987396, CHEMBL6939, CHEMBL1201330
* `type`
...
{{#if idDict.pubchem}}	#pubchem->chembl
  SELECT ?pubchem_id ?pubchem_molecular_formula ?pubchem_label ?pubchem_molecular_weight ?pubchem_smiles ?pubchem_inchi  ?pubchem_formula_img ?chembl_id ?chembl_type ?chembl_molecular_formula  {{#if togoidDict.chembl_uri}}   (GROUP_concat(?label_temp; separator = ", ") as ?chembl_label)  {{/if}} ?chembl_molecular_weight ?chembl_smiles ?chembl_inchi ?chembl_formula_img
{{/if}}
 {{#if idDict.chembl }}	#chembl->pubchem
SELECT  ?chembl_id ?chembl_type ?chembl_molecular_formula    (GROUP_concat(?label_temp; separator = ", ") as ?chembl_label)   ?chembl_molecular_weight ?chembl_smiles ?chembl_inchi ?chembl_formula_img ?pubchem_id ?pubchem_molecular_formula ?pubchem_label ?pubchem_molecular_weight ?pubchem_smiles ?pubchem_inchi    {{#if togoidDict.pubchem_uri }} ?pubchem_formula_img {{/if}} 
{{/if}}
